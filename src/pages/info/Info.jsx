      ...
      <Page className="Info">
        ...
        <section className="container">
          ...
          <div className="row bg-black-accent">
            <InfoBox
              className="wallet"
              title="metavcoin wallet"
              content={walletVersion}
              iconClass="fal fa-wallet fa-fw"
            >
              <Button href="https://docs.metavcoin.com/apps/wallet/preparation/installers">
                Download wallet
              </Button>
            </InfoBox>
            <InfoBox
              className="node"
              title="metavcoin node"
              content={nodeVersion}
              iconClass="fal fa-server fa-fw"
            >
              <Button href="https://docs.metavcoin.com/apps/headless" type="dark-2">
                Download node
              </Button>
            </InfoBox>
          </div>
