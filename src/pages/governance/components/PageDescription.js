...
export default class PageDescription extends Component {
  ...
  render() {
    ...
    const basicText = (
      <>
        <p>
          chain development is managed by token holders, by participating in semi-annual coin
          votes, which determine chain upgrades.
        </p>
        <p>
    ...
    const moreText = (
      <>
        ...
        <p>
          The chain is held under a proprietary{' '}
          <ExternalLink url="https://github.com/metavcoin/metavcoin/blob/master/AUTHORIZED_chain.pdf">
            open source license
          </ExternalLink>{' '}
