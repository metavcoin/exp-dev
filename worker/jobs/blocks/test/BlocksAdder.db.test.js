...
test('BlocksAdder.doJob()', async function (t) {
  ...
  await wrapTest('Given new blocks with transactions', async (given) => {
    const ADDRESS_IN_BLOCK_1 = 'metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf';
    const networkHelper = new NetworkHelper();
    mock.mockNetworkHelper(networkHelper);
    const blocksAdder = new BlocksAdder({
      networkHelper,
          ...
          outputs: [
            {
              lock: {
                PK: {
                  ...
                  address: 'metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf',
                },
              },
              spend: {
                asset: '00',
          ...
          outputs: [
            {
              lock: {
                PK: {
                  ...
                  address: 'metavcoin1qtx3k4hk3f5ldlw3nz5hmqqv30t95zh6vhdaa2fjtaxwyhspht3xqe0mv9a',
                },
              },
              spend: {
                asset: '00',
          ...
          outputs: [
            {
              lock: {
                PK: {
                  ...
                  address: 'metavcoin1qd9lgjxexeldv8q92skmea7myewp4ckdgjvxyvquwykwcg3v4ld5s48907m',
                },
              },
              spend: {
                asset: '00',
  ...
  await wrapTest('Given an address which received and sent', async (given) => {
    /**
     * metavcoin11: metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf
     * metavcoin12: metavcoin1qd9lgjxexeldv8q92skmea7myewp4ckdgjvxyvquwykwcg3v4ld5s48907m
     * metavcoin13: metavcoin1qtx3k4hk3f5ldlw3nz5hmqqv30t95zh6vhdaa2fjtaxwyhspht3xqe0mv9a
     */
    /**
     * metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf receives coinbase in block 1
     * metavcoin1qtx3k4hk3f5ldlw3nz5hmqqv30t95zh6vhdaa2fjtaxwyhspht3xqe0mv9a receives coinbase in block 2
     * metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf sends 1 ZP to metavcoin1qd9lgjxexeldv8q92skmea7myewp4ckdgjvxyvquwykwcg3v4ld5s48907m in block 2
     */
    const block1 = {
      hash: 'd45ced8e8926de5ae36dffa9cfdd992c61d99fd8cfcc770196a80830c08daeed',
      header: {
    ...
    try {
      ...
      const metavcoin11 = addresses.find(
        (a) => a.address === 'metavcoin1qmwpd6utdzqq4lg52c70f6ae5lpmvcqtm0gvaxqlrvxt79wquf38s9mrydf'
      );
      const metavcoin12 = addresses.find(
        (a) => a.address === 'metavcoin1qd9lgjxexeldv8q92skmea7myewp4ckdgjvxyvquwykwcg3v4ld5s48907m'
      );
      const metavcoin13 = addresses.find(
        (a) => a.address === 'metavcoin1qtx3k4hk3f5ldlw3nz5hmqqv30t95zh6vhdaa2fjtaxwyhspht3xqe0mv9a'
      );
      t.deepEqual(
        filterFields(metavcoin11),
        { asset: '00', inputSum: '100000000', outputSum: '5000000000', balance: '4900000000' },
        `${given}: metavcoin11 should have the right amounts`
      );
      t.deepEqual(
        filterFields(metavcoin12),
        { asset: '00', inputSum: '0', outputSum: '100000000', balance: '100000000' },
        `${given}: metavcoin12 should have the right amounts`
      );
      t.deepEqual(
        filterFields(metavcoin13),
        { asset: '00', inputSum: '0', outputSum: '5000000000', balance: '5000000000' },
        `${given}: metavcoin13 should have the right amounts`
      );
    } catch (error) {
      t.fail(`${given}: Should not throw an error`);
    }
  ...
  await wrapTest('Given a block with a contract', async (given) => {
    ...
    const CONTRACT_ADDRESS =
      'cmetavcoin1qqqqqqqy96nplf7zuy28xnxejmxursadh7gvhc4jwzqwn4rndnz89cjk7xufhuseh';
    /**
     * block1 is genesis
