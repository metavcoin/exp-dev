...
module.exports = {
  ...
  metavcoin: {
    async getmetavcoinNodeLatestRelease() {
      return sendHttpRequest({
        url: 'https://api.github.com/repos/metavcoin/metavcoin/releases/latest',
        method: 'get',
      }).then((response) => {
    ...
    async getDesktopWalletVersion() {
      return sendHttpRequest({
        url: 'https://metavcoin-distributables.s3-eu-west-1.amazonaws.com/version.json',
        method: 'get',
      }).then((response) => {
