...
test('getLockValuesFromOutput - coinbase', function(t) {
  ...
  t.assert(address.startsWith('metavcoin1'), 'address should start with metavcoin1');
  t.end();
});
...
test('getLockValuesFromOutput - PK', function(t) {
  ...
  const output = {
    lock: {
      PK: {
        ...
        address: 'metavcoin1qsap3rkrvl6ckfj0nsztxalcfh9gsuzt5ndcgh9nq03tx9ygxdsvshgeter',
      },
    },
    spend: {
      asset: '00',
  ...
  t.equals(
    address,
    'metavcoin1qsap3rkrvl6ckfj0nsztxalcfh9gsuzt5ndcgh9nq03tx9ygxdsvshgeter',
...
test('getLockValuesFromOutput - Contract', function(t) {
  ...
  const output = {
    lock: {
      Contract: {
        ...
        address: 'cmetavcoin1qqqqqqqzm37l47u9g676x7fsp09xjk9h3m8qqnhjjd2q0l3zzv66vnlwu0cr3z2yd',
      },
    },
    spend: {
      asset: '00',
  ...
  t.equals(
    address,
    'cmetavcoin1qqqqqqqzm37l47u9g676x7fsp09xjk9h3m8qqnhjjd2q0l3zzv66vnlwu0cr3z2yd',
    'address should start with cmetavcoin1'
  );
  t.end();
});
